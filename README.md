...
- [Enquête de terrain](https://github.com/LeandreGachet/enquete-terrain-pratiques-musicales) : compte rendu critique de ce que les conditions de collecte abîment
...
- [Maison](https://github.com/LeandreGachet/maison-app) : application Android pour le stock, le dressing, le ménage et l'agenda, 27 services métier
- [Rentabilité horaire](https://github.com/LeandreGachet/optimisation-rentabilite-gta-online) : modèle Excel de 426 formules, coûts et temps que personne n'affiche
...
- [Aléatoire](https://github.com/LeandreGachet/app-aleatoire) : tirages au sort avec historique persistant, React Native et SQLite

---

### Expérience

**Data scientist**, AVISIA, conseil en données et IA. Mission de 6 mois chez un client du secteur de l'énergie.<br>
