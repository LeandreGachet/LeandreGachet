...
Économétrie et inférence causale, apprentissage automatique, séries temporelles, traitement du langage — avec l'ingénierie des données et les outils de restitution qui les accompagnent.
...
| **[Analyse de survie — attrition](https://github.com/LeandreGachet/analyse-survie-attrition-client)** | Kaplan-Meier, Cox, hypothèse des risques proportionnels |
...
| **[Morphologie d'oiseaux](https://github.com/LeandreGachet/classification-morphologie-oiseaux)** | k-means, CAH de Ward, mélange gaussien EM — comparés |
...
| **[Série industrielle — Box-Jenkins](https://github.com/LeandreGachet/prevision-arima-serie-industrielle)** | **Zivot-Andrews**, ADF, KPSS, différenciation saisonnière |
...
| Projet | Ce qu'il traite |
|---|---|
| **[Entrepôt hospitalier](https://github.com/LeandreGachet/entrepot-donnees-hospitalier)** | Audit, ETL sous FME, cinq tables de faits, Power BI |
| **[Entrepôt de ventes](https://github.com/LeandreGachet/entrepot-donnees-ventes)** | Deux sources réconciliées, trois zones, modèle en étoile |
| **[Catalogue produits](https://github.com/LeandreGachet/catalogue-produits-collecte-automatisee)** | Collecte automatisée et structuration |
| **[Avis Allociné](https://github.com/LeandreGachet/traitement-donnees-allocine)** | Analyse d'un format non standard vers CSV |
| **[Base relationnelle sous Access](https://github.com/LeandreGachet/base-de-donnees-relationnelle-access)** | Dictionnaire des données, normalisation, requêtes métier |
...
| Projet | Ce qu'il traite |
|---|---|
| **[Calcul symbolique et itinéraires](https://github.com/LeandreGachet/python-calcul-symbolique-et-itineraires)** | Expressions dérivables, descente de gradient, API GraphHopper |
...
📍 Ouvert aux opportunités à Nantes, Rennes, Saint-Brieuc et Tours
